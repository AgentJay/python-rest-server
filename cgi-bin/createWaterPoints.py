...
import sys, json, datetime, math, psycopg2, ee, earthEngine, urllib, random
...
for pathRow in pathRows:
    ...
    #         print e.message
    #     random_points = ee.FeatureCollection.randomPoints(fc, SCENE_RANDOM_POINT_COUNT)
