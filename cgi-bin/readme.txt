...
cgi-bin 		-	Python server side extensions for the DOPA REST Services Directory
	...
	dbconnect.py	-	Python file containing credentials information for connecting to the various databases and service providers
	services	-	Main implementation file for the REST Services Directory
