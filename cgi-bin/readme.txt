...
cgi-bin 			-	Python server side extensions for the DOPA REST Services Directory
	...
	dbconnect.py		-	Python file containing credentials information for connecting to various databases and service providers 	earthEngine.py  	-     	Python wrapper for many of the features available in Google Earth Engine
